...
const commonOptions = {
  staleTime: 0,
  gcTime: 1000 * 60 * 5, // Go back to default of 5 mins in ms
};
...
export function useAppointments() {
  ...
  // Select function that returns only the applicable appointments. The useCallback is used to memo-ize the function
  ...
  // Prefetch next months's appointments
  //   1. get queryClient
  //   2. Use effect and queryClient.prefetchQuery to get next month's appointments
